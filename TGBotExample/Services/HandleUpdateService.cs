...
public class HandleUpdateService
{
    ...
    private async Task<Message> OnStart(ITelegramBotClient botClient, Message message)
    {
        ...
        InlineKeyboardMarkup inlineWeekKeyboard = new(new[]
        {
            new[]
            {
                InlineKeyboardButton.WithCallbackData(text: "Сегодня", callbackData: "today"),
    ...
    {
        InlineKeyboardMarkup inlineAllRightKeyboard = new(new[]
        {
            new[] {
    ...
    private async Task QueryUpdate(ITelegramBotClient botClient, CallbackQuery query)
    {
        try
        {
            ...
            InlineKeyboardMarkup inlineDayKeyboard = new(new[]
            {
            ...
            InlineKeyboardMarkup inlineTimeKeyboard = new(new[]
            {
            ...
            InlineKeyboardMarkup inlineYNBuildingKeyboard = new(new[]
            {
                new[]
                {
            ...
            InlineKeyboardMarkup inlineBuildingKeyboard = new(new[]
            {
            ...
            InlineKeyboardMarkup inlineYNRoomKeyboard = new(new[]
            {
                new[] {
